...
PIPELINE_CSS = {
    ...
    'firefox_whatsnew_mobile_download_50': {
        'source_filenames': (
            'css/base/simple_footer.less',
            'css/base/send-to-device.less',
            'css/firefox/whatsnew/whatsnew-mobile-download-50.less',
        ),
        'output_filename': 'css/firefox_whatsnew_mobile_download_50-bundle.css',
    },
